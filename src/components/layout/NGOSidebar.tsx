...
export default function NgoSidebar({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div
                className={`fixed inset-y-0 left-0 z-50 flex h-screen w-64 transform flex-col border-r border-gray-200 bg-white shadow-xl transition-transform duration-300 ease-in-out 
